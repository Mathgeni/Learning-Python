...
async def call(company_name, phone, time):
    await asyncio.sleep(time)
    return f'Company {company_name}: {phone} дозвон успешен'


async def main():
    tasks = [asyncio.create_task(call(company['Name'], company['Phone'], company['call_time'])) for company in data]
